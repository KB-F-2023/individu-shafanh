...
# menghitung jarak rute yang mengunjungi semua kota dalam urutan yang diberikan. 
# Ini mengembalikan invers dari jarak sebagai skor fitness
...
# membuat populasi awal rute acak
...
# membuat rute baru yang menggabungkan karakteristik dari kedua parent
...
# menukar dua kota dalam rute tertentu dengan probabilitas yang ditentukan oleh tingkat mutasi
def mutate(route):
...
# dua rute teratas berdasarkan skor fitness mereka, melakukan breeding dan mutasi untuk menciptakan rute baru hingga ukuran populasi tercapai
